                          ...
                          unsigned long len, void *data )
{
    ...
    else if ((parm[0][0] == 'w'))
    {
        ...
        {
        case 'c':
            WRITE_CBUS_REG(addr, val);
            retval = READ_CBUS_REG(addr);
            break;
        case 'p':
            WRITE_APB_REG(addr, val);
            retval = READ_APB_REG(addr);
            break;
        case 'a':
            addr = addr << 2;
            ...
            break;
        case 'x':
            WRITE_AXI_REG(addr, val);
            retval = READ_AXI_REG(addr);
            break;
        case 'h':
            WRITE_AHB_REG(addr, val);
            retval = READ_AHB_REG(addr);
            break;
        case 'm':
            WRITE_MPEG_REG(addr, val);
            retval = READ_MPEG_REG(addr);
            break;
        case 'o':
            WRITE_AOBUS_REG(addr, val);
            retval = READ_AOBUS_REG(addr);
            break;
        default:
            printk ("Error: Invalid command!\n");

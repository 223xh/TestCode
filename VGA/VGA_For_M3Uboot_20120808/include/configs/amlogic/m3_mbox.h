...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"bootargs=root=/dev/cardblksd2 rw rootfstype=ext3 androidboot.resolution=720p rootwait init=/init console=ttyS0,115200n8 nohlt  a9_clk=600M clk81=187000000 mem=1024m quiet\0" \
    "nandargs=setenv bootargs rootfstype=ext3 androidboot.resolution=${outputmode} rootwait init=/init console=ttyS0,115200n8 nohlt logo=osd1,0x84100000,loaded,${outputmode} a9_clk=600M clk81=187000000 mem=1024m quiet\0"\
